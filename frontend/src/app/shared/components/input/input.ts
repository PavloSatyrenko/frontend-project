...
import { Component, computed, ElementRef, input, InputSignal, model, ModelSignal, OnInit, Signal, viewChild } from "@angular/core";
...
export class Input implements OnInit {
    ...
    public readonly type: InputSignal<"text" | "number" | "phone" | "password"> = input<"text" | "number" | "phone" | "password">("text");
